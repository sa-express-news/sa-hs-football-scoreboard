...
export default (hash, unmappedGame) => {
    // if game isn't relevant to our current day of the week or doesn't involve a local school, bail
    if (!filterData.isSAGame(unmappedGame) || !filterData.isInDateRange(unmappedGame)) return hash;
