...
export const buildSAMap = days => {
    ...
    days.forEach(day => {
        day.games.forEach(game => {
            if (!saMap[game.home.id] && game.home.district && game.home.district.indexOf('6A') !== -1 && game.home.district.indexOf('28') !== -1) {
                console.log(game.home.id, game.home.district, game.home.name);
                saMap[game.home.id] = game.home.name;
            }

            if (!saMap[game.away.id] && game.away.district && game.away.district.indexOf('6A') !== -1 && game.home.district.indexOf('28') !== -1) {
